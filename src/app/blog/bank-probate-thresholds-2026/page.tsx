  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <nav className="text-sm text-muted mb-6">
        ...
        <span className="mx-2">/</span>
        <span>Bank Probate Thresholds 2026</span>
      </nav>
      ...
      <div className="space-y-4 mb-12">
        ...
        <div className="bg-success-light rounded-xl p-6">
          ...
          <p className="text-sm text-green-800/80 leading-relaxed">
            Each bank typically needs an original death certificate. If the deceased had accounts at three different banks, you will need at least three certificates. Order them when you register the death at £11 each. Ordering extras later costs more and takes longer.
          </p>
        </div>
        <div className="bg-success-light rounded-xl p-6">
