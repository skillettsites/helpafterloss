...
export const metadata: Metadata = {
  ...
  description: 'Free, personalised guidance after someone passes away. A step-by-step checklist shaped around your situation, covering registration, probate, finances and more. Gentle UK bereavement support.',
  ...
  openGraph: {
    ...
    description: 'Free, personalised step-by-step guidance after someone passes away. From registering the death through to probate and beyond.',
