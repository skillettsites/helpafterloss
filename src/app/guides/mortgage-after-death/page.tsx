...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Yes. The mortgage does not pause because someone has passed away. Monthly payments must continue to avoid arrears building up. If the mortgage was joint, the surviving borrower is responsible. If it was sole, the estate is responsible, and the executor should arrange payments from the estate funds. If there is no money available, contact the lender to discuss options such as a temporary payment holiday or reduced payments.',
  },
  {
  ...
  },
  {
    ...
    a: 'If they had a mortgage protection policy (also called decreasing term life insurance), it should pay out enough to clear the remaining mortgage balance. Check their paperwork and bank statements for premium payments, and contact the mortgage broker who arranged the loan. The payout goes directly to the lender to clear the debt. If the policy was a level term life insurance, the full sum assured is paid out regardless of the remaining mortgage balance.',
  },
  {
    q: 'Can I transfer a mortgage into my name after someone dies?',
    a: 'If you were a joint borrower, this is straightforward. The lender will take their name off the mortgage once you provide the death certificate. If the mortgage was in their sole name, transferring it to you is more complex. The lender will need to assess your ability to afford the repayments. You may need to apply for a new mortgage in your own name. If you were their spouse or civil partner and you live in the property, lenders are generally willing to work with you on this.',
  },
];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-lg text-muted leading-relaxed mb-10">
        When someone passes away with a mortgage still outstanding, the debt does not disappear. That does not mean the home is automatically lost, either, which is the worry most people arrive here with. What happens next depends on whether the mortgage was joint or sole, whether there is insurance, and who inherits the property. This guide explains every situation and what your options are.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
        ...
        <div className="bg-card rounded-xl border border-border p-5 text-center">
          <p className="text-2xl font-bold text-primary">0800 151 2012</p>
      ...
      <div className="space-y-4 mb-10">
        <div className="bg-card rounded-xl border border-border p-6">
          ...
          <ul className="text-sm text-muted leading-relaxed space-y-2 list-disc pl-5">
            <li>Their paperwork, filing cabinet, or document folder</li>
            ...
            <li>Their email inbox (search for "life insurance", "protection", or "policy")</li>
      ...
      <div className="space-y-4 mb-10">
        <div className="bg-card rounded-xl border border-border p-6">
          ...
          <p className="text-sm text-muted leading-relaxed">
            Mortgage payments must continue during probate. If the mortgage was joint, the surviving borrower is responsible. If it was sole, the executor should arrange payments from their bank accounts (which banks will usually allow for essential outgoings like mortgages, even before probate is granted). If there is not enough money in those accounts, the executor may need to use their own funds temporarily and reclaim the amount from the estate later. Always keep receipts and records of any payments you make on behalf of the estate.
          </p>
        </div>
        <div className="bg-card rounded-xl border border-border p-6">
      ...
      <div className="space-y-4 mb-10">
        <div className="bg-card rounded-xl border border-border p-6">
          ...
          <p className="text-sm text-muted leading-relaxed">
            If they bought the property using a Help to Buy equity loan, the government holds an equity share in the property (typically 20%, or 40% in London). That equity loan must eventually be repaid. If the property is sold, the government's percentage share is taken from the sale proceeds. If a surviving joint owner wants to keep the property, they will need to repay the equity loan, which is based on the current market value of the property, not the original purchase price. Contact the Help to Buy agent for your region to discuss your options.
          </p>
        </div>
        <div className="bg-card rounded-xl border border-border p-6">
          <h3 className="font-semibold text-foreground mb-2">Shared ownership</h3>
          <p className="text-sm text-muted leading-relaxed">
            Shared ownership properties are part-owned and part-rented from a housing association. What happens next depends on whether the property was held as joint tenants or tenants in common. If joint tenants, the surviving owner takes over the full share and continues paying the rent on the remaining portion. If the property was in their sole name, the housing association's lease will set out what happens. Some leases allow the share to be passed to a family member; others give the housing association first refusal to buy back the share. Check the lease and contact the housing association promptly.
          </p>
        </div>
      </div>
