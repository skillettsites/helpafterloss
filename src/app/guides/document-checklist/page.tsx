...
const CATEGORIES = [
  ...
  },
  {
    ...
    urgent: false,
    items: [
      { doc: 'Death certificate (certified copies)', detail: 'Order at least 5 certified copies when you register (£11 each). You will need one for each bank, insurer, pension provider, and other institution. Ordering extras later costs more and takes longer.' },
      ...
      <div className="bg-card rounded-xl border border-border p-6 mb-12">
        ...
        <div className="space-y-3 text-sm text-muted leading-relaxed">
          ...
          <div>
            ...
            <p>You can order replacement certificates from the General Register Office (GRO) at gov.uk/order-copy-birth-death-marriage-certificate. Costs £11 per certificate.</p>
          </div>
          <div>
