    ...
    items: [
      {
        ...
        tip: 'You will need 5 to 10 certified copies. Order extras when you register the death at the register office. Each copy costs Â£12.50 in England and Wales. Many organisations will not accept photocopies.',
      },
      {
        id: 'will',
        name: 'Will',
      ...
      },
      {
        ...
        tip: 'Usually kept at home with the other important papers. If you cannot find it, you can order a replacement from the General Register Office (gro.gov.uk) for Â£11. In Scotland, apply to National Records of Scotland.',
      },
      {
        id: 'marriage-certificate',
        name: 'Marriage or civil partnership certificate',
        tip: 'Needed for pension claims, life insurance, and probate. If lost, order a replacement from the register office where the ceremony took place, or from gro.gov.uk (Â£11).',
      },
      {
        id: 'ni-number',
