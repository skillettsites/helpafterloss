...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/banks`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${baseUrl}/will-search`, lastModified: '2026-07-24', changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${baseUrl}/guides/mortgage-after-death`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/guides/life-insurance-claim`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/guides/death-certificates`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/guides/what-to-say-when-someone-dies`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/editorial-policy`, lastModified: now, changeFrequency: 'yearly', priority: 0.4 },
    ...
    { url: `${baseUrl}/blog/what-to-do-when-someone-dies-uk`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${baseUrl}/blog/how-long-does-probate-take-uk`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/grief-at-christmas`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/returning-to-work-after-bereavement`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/inheritance-tax-guide-after-death`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/grief-stages-explained`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/how-to-cope-losing-a-parent`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/tell-us-once-service-guide`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/grief-and-anxiety`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/blog/registering-a-death-uk`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
