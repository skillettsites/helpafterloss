...
export const SUPPORT_ORGANISATIONS: SupportOrganisation[] = [
  ...
  },
  {
    ...
    description: 'The UK\'s leading bereavement charity. Free support, advice, and information after a bereavement. They also offer one-to-one counselling.',
  },
  {
    ...
    description: 'Free, impartial advice on legal, financial, and practical matters after a bereavement, including benefits, debt, and housing.',
  },
  {
    name: 'Age UK',
    phone: '0800 678 1602',
    ...
    description: 'Support and advice for older people, and for anyone dealing with the loss of an older person.',
  },
  {
    ...
    description: 'Support for families and professionals when a baby or child has passed away, and for children who are grieving.',
  },
  {
  ...
  },
  {
    ...
    description: 'Free financial guidance on pensions, benefits, tax, and money matters after a bereavement.',
  },
  {
    name: 'Turn2us',
  ...
  },
  {
    ...
    description: 'Search for a registered will. Useful if you are not sure whether they left a will, or where it might be stored.',
  },
];
...
export const SUPPORT_MESSAGES = [
  ...
  'You do not have to do this on your own. The organisations listed on our support page are there to help.',
  'It is okay to take breaks. Your wellbeing matters too.',
  'Many people find that taking one task at a time makes things feel more manageable.',
