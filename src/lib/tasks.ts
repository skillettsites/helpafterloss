...
export const TASKS: Task[] = [
  ...
  },
  {
    ...
    description: 'Contact the person\'s employer to let them know. Ask about: death-in-service benefit (typically 2-4 times annual salary, paid to a nominated beneficiary), final salary payment, any holiday pay owed, return of personal belongings, and workplace pension.',
    category: 'financial',
    priority: 'important',
    estimatedMinutes: 30,
